...
export const metadata: Metadata = {
  title: "Login",
  description:
    "Sign in to HakTrak Networks - Your AI-powered Cyber Intelligence Platform",
};
    ...
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="hidden md:flex flex-col items-center justify-center bg-card/50 backdrop-blur-sm p-8">
        ...
        <p className="text-lg text-center text-muted-foreground max-w-md">
          HakTrak Networks is an AI-powered eXtended Cyber Intelligence (XCI)
          Platform that protects you against cyber threats with actionable &
