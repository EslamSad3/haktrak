...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://haktraknetworks.com/",
    siteName: "HakTrak Networks",
    title: "HakTrak Networks",
    description: "AI-powered eXtended Cyber Intelligence Platform",
    images: [
      {
        url: "https://haktraknetworks.com/wp-content/uploads/2023/06/text_black_red_head_white_BG-8.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description: "AI-powered eXtended Cyber Intelligence Platform",
    images: [
      "https://haktraknetworks.com/wp-content/uploads/2023/06/text_black_red_head_white_BG-8.png",
    ],
